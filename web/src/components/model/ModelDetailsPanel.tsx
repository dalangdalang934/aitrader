...
import { useTrades, type TradeRow } from "@/lib/api/hooks/useTrades";
  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <div>
          累计收益：
          <span className={pnlClass(latest?.return_pct)}>
            {latest?.return_pct != null
        ...
        <div>
          未实现盈亏：
          <span className={pnlClass(latest?.unrealized_pnl)}>
            {fmtUSD(latest?.unrealized_pnl)}
          </span>
        </div>
      </div>
