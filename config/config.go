...
type Config struct {
	...
	NewsWebSearchEnabled  bool   `json:"news_web_search_enabled,omitempty"`
	NewsWebSearchQuery    string `json:"news_web_search_query,omitempty"`
	NewsWebSearchInterval string `json:"news_web_search_interval,omitempty"` // 例如 "15m"
	NewsWebSearchAPIURL   string `json:"news_web_search_api_url,omitempty"`
	NewsWebSearchAPIKey   string `json:"news_web_search_api_key,omitempty"`
...
func (c *Config) Validate() error {
	...
	if strings.TrimSpace(c.NewsWebSearchQuery) == "" {
		c.NewsWebSearchQuery = "latest crypto market macro news BTC ETH regulation ETF exchange security"
	}
